...
<body>
	...
	<div class="padding-y-5 text-center">
		<div style="width: 40%" class="container padding-y-5 text-left">
			<strong class="color-main">新規登録</strong>
		</div>
	</div>
<%
...
String i = (String)session.getAttribute("icon");
				...
				<table style="width: 390px" class="table">
					<tr>
						...
						<td class="text-left"><input class="form-control" type="text"
							 pattern="^[0-9A-Za-z]+$" title="半角英数字で入力して下さい。" name="loginId" value="<%= loginId %>" size="20" /></td>
					...
					<tr>
						...
						<td class="text-left"><input class="form-control"
							type="text" name="userName" value="<%= userName %>" size="20" /></td>
					</tr>
					<tr>
						<%-- アイコン入力欄の名前はicon --%>
